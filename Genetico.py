...
def algoritmo_genetico(tamanho_populacao, limites, num_geracoes, taxa_cruzamento, taxa_mutacao, geracoes_sem_melhora_limite=50, tolerancia=1e-6):
    ...
    # Cria uma 'wrapper' para a função objetivo (funcao_w4).
    # Esta wrapper permite contar o número de vezes que a função objetivo é avaliada
    # e passa essas avaliações para o contador global de operações, caso a função w4
    ...
    return {
        ...
        "avaliacoes_funcao_total": funcao_w4_wrapper_ag.evaluations, # Total de vezes que a função objetivo foi chamada.
