...
from funcoes_otimizacao import funcao_w4 # Importa a função 'funcao_w4' do arquivo 'funcoes_otimizacao.py', que é a função objetivo a ser otimizada (minimizada neste caso).
